...
class WeatherRepositoryImpl(
    ...
    override suspend fun getWeatherInfoByCords(lat: Double, lon: Double): WeatherEntity {
        return withContext(Dispatchers.IO){
            (WeatherResponseMapper::mapToDomain)(remoteSource.getWeatherByCords(latitude = lat, longitude = lon))
        }
    }
